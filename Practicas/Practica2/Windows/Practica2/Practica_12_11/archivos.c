...
*	Descripcion : lee el contenido del archivo y lo muestra en pantalla
*	Recibe : un archivo exitente
*	Devuelve : -1 si no logra abrir el archivo. 1 si lo logra
*/
...
int leerArchivoW(archivo *archivo)
{
	...
	if(fp == NULL){
 	...
 	fscanf(fp, "%s" ,archivo->contenido);
 	printf("%s",archivo->contenido);
